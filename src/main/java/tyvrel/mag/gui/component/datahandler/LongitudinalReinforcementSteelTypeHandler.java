 ...
 */
public class LongitudinalReinforcementSteelTypeHandler extends AbstractDataHandler {
	public LongitudinalReinforcementSteelTypeHandler(ApplicationFrame applicationFrame) {
