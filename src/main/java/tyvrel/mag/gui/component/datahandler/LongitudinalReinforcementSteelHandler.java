 ...
 */
public class LongitudinalReinforcementSteelHandler extends AbstractDataHandler {
	public LongitudinalReinforcementSteelHandler(ApplicationFrame applicationFrame) {
	...
	public Steel get() throws DataHandlerException {
		...
		return get(message, applicationFrame -> notNull(applicationFrame.getMaterialsPanel()
				.getLongitudinalReinforcementSteel()));
	}
